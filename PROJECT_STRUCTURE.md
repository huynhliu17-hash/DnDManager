...
> This file is the index only. For specific information, grep the relevant domain file under `docs/`.

| Domain | File | Contents |
|--------|------|----------|
| Stack & Files | [`docs/stack-files.md`](docs/stack-files.md) | tech stack, file map, key element IDs, key conventions, running |
| DB Schema | [`docs/schema.md`](docs/schema.md) | all tables, columns, migration notes |
